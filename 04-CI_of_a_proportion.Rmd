...
**[ ]** Figure 4.1: What would happen if you collected many samples and computed a 95% CI for each
...
This section is **OPTIONAL**.  In practice We will always use software to do these calculations.
